    ...
    <td key={cellId}>
      <TableActionsCellWrapper cellId={cellId}>
        <div
          ...
          className={`group bg-slate-10 hover:border-2 flex flex-col items-center h-full w-full justify-center min-w-[14rem] min-h-[6rem] p-2 transition-all rounded-md shadow-sm border border-1 border-slate-200 ${
            isEditMode
